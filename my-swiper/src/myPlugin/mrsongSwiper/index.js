...
//  Vue.component()引用方法
mrsongSwiper.install = Vue => Vue.component(mrsongSwiper.name, mrsongSwiper);//注册组件

// Vue.use()引用方法
// 标签的方式引入，留到后面再另开新篇讨论
//const install = function(Vue, opts = {}) { 
//　　Vue.component(mrsongSwiper.name, mrsongSwiper);
//}
